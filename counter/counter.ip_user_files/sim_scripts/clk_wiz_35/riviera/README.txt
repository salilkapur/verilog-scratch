...
#
# Generated by export_simulation on Sat Feb 24 16:39:24 EST 2018
#
################################################################################
...
switch to the './clk_wiz_35.sh' script.

./clk_wiz_35.sh -reset_run
...
./clk_wiz_35.sh -noclean_files

For more information on the script, please type './clk_wiz_35.sh -help'.
